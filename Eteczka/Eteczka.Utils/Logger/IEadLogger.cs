...
namespace Eteczka.Utils.Logger
{
    public interface IEadLogger
    {
        ...
        void LOG_MAIN_LOG(PoziomLogowania poziom, Akcja akcja, SessionDetails sesja, bool sucess, string NazwaTabeli, object TabelaPo, object TabelaPrzed = null, string message = null);
