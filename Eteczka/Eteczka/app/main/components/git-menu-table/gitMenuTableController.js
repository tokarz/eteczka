'use strict';
angular.module('et.controllers').controller('gitMenuTableController', ['$rootScope', '$scope', '$state', 'filesViewService', 'modalService', 'companiesService', function ($rootScope, $scope, $state, filesViewService, modalService, companiesService) {
        $scope.newrows = [];
        $scope.stagedrows = [];
        $scope.loading = false;
