'use strict';
angular.module('et.controllers').controller('menuFilesContentController', ['$rootScope', '$scope', '$state', '$timeout', 'filesViewService', 'shopCartService', 'modalService', 'cacheService', 'usersService', function ($rootScope, $scope, $state, $timeout, filesViewService, shopCartService, modalService, cacheService, usersService) {
