...
ALTER TABLE public."KatLoginyDetale"
  OWNER TO eadadmin;
    GRANT ALL ON TABLE "KatLoginyDetale" TO ead;
...
ALTER TABLE public."KatDokumentyRodzaj"
  OWNER TO eadadmin;
    GRANT ALL ON TABLE "KatDokumentyRodzaj" TO ead;
...
(
  ...
  opisdodatkowy character(254), -- Wlasny, dowolny opis wprowzdzony przez Kozel
...
ALTER TABLE public."Pliki"
    OWNER TO eadadmin;
    GRANT ALL ON TABLE "Pliki" TO ead;
